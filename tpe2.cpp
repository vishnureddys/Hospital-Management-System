...
Note:-My First C++ Project for building a hospital management system for my college lab assignment..It may not be a perfect one as it is my first project..I worked hard to come up with a good one in limited time..hope u like it :):):) 
